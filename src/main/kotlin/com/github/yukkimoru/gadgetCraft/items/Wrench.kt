...
class Wrench private constructor(plugin: JavaPlugin) : Listener {
    companion object {
        private var instance: Wrench? = null

        fun getInstance(plugin: JavaPlugin): Wrench {
            if (instance == null) {
                instance = Wrench(plugin)
            }
            return instance!!
        }
    }
    ...
    private val cooldown: Long = 1L // 20 ticks = 1 second
    private val gadgetCraftID = 0
